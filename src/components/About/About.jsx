...
function About() {
    ...
    <section>
        ...
        <div className="about-container padding">
                ...
                <div>
                    <p>Natural Horsemanship drastically altered Laura's perception of working with horses and provided her with a new trajectory towards not just riding, but the actual training and teaching of the horse. Thanks to Page and Louis (and Laura's supportive parents :) Laura had the opportunity to participate in dozens of clinics on different horses of various skill levels. This instruction continued until Laura was accepted to Elon University in Elon, NC.</p>
        ...
        <div className="container-fluid padding">
            <div className="row align-items-start justify-content-center mx-auto padding">
