function Lessons() {
    return(
        ...
        <div class="container-fluid">
            <div class="row mx-auto">
                <div class="col-12 text-center">
                    <h1 class="page-header py-2 my-2">Training with Topline</h1>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid pading">
            <div class="row mx-auto">
                <div class="col-12">
                    <h2 class="content-header">Lesson Details</h2>
                    ...
                    <p>If you have your own horse or you are more than welcome to trailer in to our facility in Apex, NC
                        for a lesson. If you do not have a horse of your own, or you are interested in tuning up your
        ...
        <div class="container-fluid padding">
            <div class="row justify-content-center">
                <div class="col-10 col-sm-6 col-md-5 p-2">
                    <div class="card border">
                        <img src="../images/square-ava-jump-outdoor.jpg" class="card-img" alt="..." />
                        <div class="card-img-overlay d-flex align-items-center">
                            <div class="card-overlay-title">
                                <h3 class="card-title lessons">Standard Lesson</h3>
                                <p class="hide">(Tap for Details)</p>
                            </div>
                ...
                <div class="col-10 col-sm-6 col-md-5 p-2">
                    <div class="card border">
                        <img src="../images/square-indoor-rail.jpg" class="card-img" alt="..." />

                        <div class="card-img-overlay d-flex align-items-center">
                            <div class="card-overlay-title">
                                <h3 class="card-title lessons">Training Programs</h3>
                                <p class="hide">(Tap for Details)</p>
                            </div>
                            <div class="card-text p-3">
        ...
        <div class="container-fluid padding">
            <div class="row mx-auto">
                <div class="col-12 pb-0 ">
                    <h2 class="content-header">For Your Consideration</h2>
        ...
        <div class="container-fluid padding">
            <div class="row mx-auto">
                <div class="col-12 border border-danger rounded">
                    <h2 class="content-header">Safety</h2>
